...
def odometry_based_motion_estimate(x,u,alpha):
    # u: (delta_rot1, delta_rot2, delta_trans) Odometry readings 
...
def main():
    ...
    for i in range(num_eval):
        new_pose[i,:] = odometry_based_motion_estimate(pose_start,odometry_reading_start,noise_param)
